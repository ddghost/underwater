...
train_data_root = 'data:(3800, 10000)/'
test_data_root = 'data/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/cas_x101_64x4d_fpn_htc_twoDataset_big'
load_from = './work_dirs/cas_x101_64x4d_fpn_htc_twoDataset_small/latest.pth'
resume_from = None
workflow = [('train', 1)]