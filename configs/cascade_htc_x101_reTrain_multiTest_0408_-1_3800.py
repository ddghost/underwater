...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/train/annotations/train_-1_3800.json',
        img_prefix=data_root + 'train/image/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        ann_file='data/train/annotations/testA_-1_3800.json',
...
log_level = 'INFO'
work_dir = './work_dirs/cas_x101_64x4d_fpn_htc_reTrain_-1_3800'
